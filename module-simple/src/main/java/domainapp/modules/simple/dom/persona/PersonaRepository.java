...
public class PersonaRepository {
	...
	public List<Persona> buscarPorNombre(final String personaNombre) {
		return repositoryService.allMatches(
				new QueryDefault<>(Persona.class, "buscarPorNombre", "personaNombre", personaNombre.toLowerCase()));
	}
	
	public List<Persona> buscarPorDNI(final int personaDni) {
		return repositoryService
				.allMatches(new QueryDefault<>(Persona.class, "buscarPorDNI", "personaDni", personaDni));
	}
	@Inject
